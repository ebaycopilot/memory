...
- The startup launcher now polls Gateway readiness every 3 minutes up to 10 times, and only opens the dashboard after both `[gateway] ready` and `[heartbeat] started` appear in the Gateway terminal.
